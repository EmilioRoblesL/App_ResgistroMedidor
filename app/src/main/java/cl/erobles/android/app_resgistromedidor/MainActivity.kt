...
import cl.erobles.android.app_resgistromedidor.ui.theme.App_ResgistroMedidorTheme
...
@Preview(showSystemUi = true, showBackground = true)
@Composable
fun FormRegistroUI(onButtonRegistrarClicked: () -> Unit = {},
                   vm: claseVM = viewModel()
) {
